...
Car2Go.prototype.operationareas = function(options,callback) {
  options.format = options.format || "kml";
  ...
  request({
    ...
    url: "https://www.car2go.com/api/v2.1/operationareas"
  }, function(err, res, body) {
    if (err) {
      return callback(err);
    }
...
Car2Go.prototype.gasstations = function(options,callback) {
  options.format = options.format || "kml";
  ...
  request({
    ...
    url: "https://www.car2go.com/api/v2.1/gasstations"
  }, function(err, res, body) {
    if (err) {
      return callback(err);
    }
